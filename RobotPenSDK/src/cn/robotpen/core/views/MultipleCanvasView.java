...
import cn.robotpen.core.views.ShapeView.ShapeModel;
...
//        mPenPaint.setStrokeJoin(Paint.Join.ROUND);
     ...
     * @param pressure 压力
     */
    public void drawLine(int x, int y, boolean isRoute,float pressure){
        ...
        mPenDrawView.drawLine(x, y, isRoute, paint, pressure);
    }
