...
public class Keys {
	...
	/**后台ble服务key**/
	public static final String APP_PEN_SERVICE_NAME = "cn.robotpen.core.services.SmartPenService";
	
	/**后台USB服务key**/
	public static final String APP_USB_SERVICE_NAME = "cn.robotpen.core.services.UsbPenService";
	
	/**广播设置发送广播状态**/
	public final static String ACTION_SERVICE_SETTING_SEND_RECEIVER = "cn.robotpen.core.services.setting.Send_Receiver";
	
	/**广播设置场景类型**/
	public final static String ACTION_SERVICE_SETTING_SCENE_TYPE = "cn.robotpen.core.services.setting.Scene_Type";

	/**发送笔迹广播包**/
	public final static String ACTION_SERVICE_SEND_POINT = "cn.robotpen.core.services.Send_Point";
	
	/**发送ble连接设备广播**/
	public final static String ACTION_SERVICE_BLE_CONNECT = "cn.robotpen.core.services.ble.Connect";
	
	/**发送ble断开设备广播**/
	public final static String ACTION_SERVICE_BLE_DISCONNECT = "cn.robotpen.core.services.ble.Disconnect";
	
	/**发送ble连接状态**/
	public final static String ACTION_SERVICE_BLE_CONNECT_STATE = "cn.robotpen.core.services.ble.Connect_State";
	
	/**发送开始BLE扫描**/
	public final static String ACTION_SERVICE_BLE_SCAN = "cn.robotpen.core.services.ble.Scan";
	
	/**发送ble 发现到的设备**/
	public final static String ACTION_SERVICE_BLE_DISCOVERY_DEVICE = "cn.robotpen.core.services.ble.Discovery_Device";
	
	public final static String ACTION_SERVICE_USB_CONNECT = "cn.robotpen.core.services.usb.Connect";
	public final static String ACTION_SERVICE_USB_DISCONNECT = "cn.robotpen.core.services.usb.Disconnect";
